 ...
 */
public class DevotionalFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = DevotionalFragment.class.getName();
    private static final String newsCategory = "devotional";
