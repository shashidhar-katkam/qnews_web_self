 ...
 */
public class WeatherFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = WeatherFragment.class.getName();
    private static final String newsCategory = "weather";
