 ...
 */
public class InfoFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = InfoFragment.class.getName();
    private static final String newsCategory = "info";
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String businessUrl = NewsPreferences.getPreferredUrl(getContext(), getString(R.string.ic_title_useful_info));
