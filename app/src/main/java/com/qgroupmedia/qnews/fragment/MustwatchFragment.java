 ...
 */
public class MustwatchFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = MustwatchFragment.class.getName();
    private static final String newsCategory = "mustwatch";

    public MustwatchFragment() {
        super(newsCategory);
    }
