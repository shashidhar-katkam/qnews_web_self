 ...
 */
public class MusicFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = MusicFragment.class.getName();
    private static final String newsCategory = "qmusic";
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String businessUrl = NewsPreferences.getPreferredUrl(getContext(), getString(R.string.ic_title_music));
