 ...
 */
public class CorruptionFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = CorruptionFragment.class.getName();
    private static final String newsCategory = "corruption";

    public CorruptionFragment() {
        super(newsCategory);
    }
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String businessUrl = NewsPreferences.getPreferredUrl(getContext(), getString(R.string.ic_title_corruption));
