 ...
 */
public class WomenFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = WomenFragment.class.getName();
    private static final String newsCategory = "women";
