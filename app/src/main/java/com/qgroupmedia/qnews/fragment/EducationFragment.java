 ...
 */
public class EducationFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = EducationFragment.class.getName();
    private static final String newsCategory = "education";
