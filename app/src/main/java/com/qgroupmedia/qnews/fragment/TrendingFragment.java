 ...
 */
public class TrendingFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = TrendingFragment.class.getName();
    private static final String newsCategory = "business";
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String businessUrl = NewsPreferences.getPreferredUrl(getContext(), getString(R.string.ic_title_business));
