 ...
 */
public class TimepassFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = TimepassFragment.class.getName();
    private static final String newsCategory = "timepass";

    public TimepassFragment() {
        super(newsCategory);
    }
