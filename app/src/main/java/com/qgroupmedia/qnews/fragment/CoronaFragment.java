 ...
 */
public class CoronaFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = CoronaFragment.class.getName();
    private static final String newsCategory = "corona";
