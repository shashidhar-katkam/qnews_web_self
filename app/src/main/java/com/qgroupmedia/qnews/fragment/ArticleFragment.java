 ...
 */
public class ArticleFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = ArticleFragment.class.getName();
    private static final String newsCategory = "article";
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        String businessUrl = NewsPreferences.getPreferredUrl(getContext(), getString(R.string.ic_title_article));
