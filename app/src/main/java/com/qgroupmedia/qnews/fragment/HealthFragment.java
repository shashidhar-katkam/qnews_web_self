 ...
 */
public class HealthFragment extends BaseArticlesFragment {

    private static final String LOG_TAG = HealthFragment.class.getName();
    private static final String newsCategory = "health";
